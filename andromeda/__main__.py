...
if __name__=="__main__":
    ...
    t=Transition(1.23975, bodytube1=bt50, bodytube2=_29mm, shoulder=.75, thickness = 1/16., bodytube3=bt20, open_end=True)
    render_to_file(t.transition, os.path.join(basedir,"bt50t.scad"))
    t=Transition(1.67725, bodytube1=_29mm, bodytube2=bt60, shoulder=.75, thickness = 1/16., bodytube3=bt50, open_end=True)
