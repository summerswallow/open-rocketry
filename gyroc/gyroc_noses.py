...
nc = ScrewInBase(nc, shoulder=0.1, thread_height=.5, thread_diameter=bt70.inner_diameter-.1, threads_per_inch=10)
...
nc = ThreadedBaseOutsetScrewInBase(nc, shoulder=1.0, thread_height=.5, thread_diameter=2.4, lower_tpi=6, upper_tpi=8)
