...
utils.render_to_file(Coupler(2, bodytube=bt50, threads_per_inch=6, inner_bodytube=bt5, thickness=1 / 16.).male, "test.scad")
utils.render_to_file(Coupler(2, bodytube=bt50, threads_per_inch=6, inner_bodytube=bt5, thickness=1 / 16.).female, "test2.scad")
